...
// 用来绘图的颜色
#define COLOR_SNAKE			RGB(19, 29, 32)
#define COLOR_FOOD			RGB(242, 14, 14)
#define COLOR_BOUNDARY		RGB(105, 96, 149)
#define COLOR_TEXT			RGB(173, 216, 230)

// 游戏的参数的设置 
#define INIT_TIMER_ELAPSE	300	// 初始的时钟周期，确定游戏初始速度
#define	ONE_LEVELS_SCORES	5	// 每升级一次需要的计分
#define INIT_SNAKE_LEN		3	// 蛇的长度
#define SPEEDUP_RATIO		1 // 升级以后时间周期（确定游戏速度）提高的比例。
